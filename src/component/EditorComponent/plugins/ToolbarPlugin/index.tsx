  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text">{ELEMENT_FORMAT_OPTIONS.justify.name}</span>
      </DropDownItem>
      <DropDownItem
        onClick={() => {
      ...
      >
        ...
        />
        <span className="text">{ELEMENT_FORMAT_OPTIONS.start.name}</span>
      </DropDownItem>
      <DropDownItem
        onClick={() => {
      ...
      >
        ...
        />
        <span className="text">{ELEMENT_FORMAT_OPTIONS.end.name}</span>
      </DropDownItem>
      <Divider />
      <DropDownItem
        onClick={() => {
      ...
      >
        ...
        <span className="text">インデント減</span>
      </DropDownItem>
      <DropDownItem
        onClick={() => {
      ...
      >
        ...
        <span className="text">インデント増</span>
      </DropDownItem>
    </DropDown>
  );
}
        ...
        <>
          ...
          >
            ...
            >
              ...
              <span className="text">取り消し線</span>
            </DropDownItem>
            <DropDownItem
              onClick={() => {
            ...
            >
              ...
              <span className="text">下付き文字</span>
            </DropDownItem>
            <DropDownItem
              onClick={() => {
                activeEditor.dispatchCommand(
            ...
            >
              ...
              <span className="text">上付き文字</span>
            </DropDownItem>
            <DropDownItem
            ...
            >
              ...
              <span className="text">書式のクリア</span>
            </DropDownItem>
          </DropDown>
          <Divider />
          <DropDown
